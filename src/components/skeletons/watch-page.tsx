export default function SkeletonWatchPage() {
  return (
    <div className='md:w-[750px] flex flex-col gap-3 px-2'>
      ...
      <div className='flex gap-3'>
        ...
        <div className='flex flex-col w-full gap-1'>
          <div className='w-3/4 md:w-1/4 h-4 bg-[#e3e3e3] dark:bg-muted rounded-full animate-pulse'></div>
          <div className='w-3/4 md:w-1/6 h-4 bg-[#e3e3e3] dark:bg-muted rounded-full animate-pulse'></div>
        </div>
